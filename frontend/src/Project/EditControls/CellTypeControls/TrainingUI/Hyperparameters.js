...
import { Box, Chip, FormLabel, MenuItem, Paper, TextField, Typography } from '@mui/material';
...
function Hyperparameters({ badBatch }) {
    ...
    const marks = [
        { value: 50, label: '50%' }, { value: 60 }, { value: 70 }, { value: 80 }, { value: 90 }, { value: 100, label: '100%' },
      ];
            ...
            <Grid container direction='column' spacing={'2vh'}>
                ...
                <Grid item>
                    <TextField
                        ...
                        sx={{width: '60%'}}
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><ScatterPlotIcon sx={{marginLeft: '-20%'}}/></InputAdornment>,
                        }}
                    >
                ...
                <Grid item>
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><HeightIcon sx={{marginLeft: '-20%'}}/></InputAdornment>,
                        }}
                    >
                ...
                <Grid item>
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><AccessTimeIcon sx={{marginLeft: '-20%'}}/></InputAdornment>,
                        }}
                    >
                ...
                <Grid item>
                    <TextField
                        ...
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><SpeedIcon sx={{marginLeft: '-20%'}}/></InputAdornment>,
                        }}
                    >
                        {lrs.map((opt, index) => (
                            <MenuItem key={index} value={index}>
