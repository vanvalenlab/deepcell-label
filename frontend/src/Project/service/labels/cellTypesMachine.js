            ...
            getCellTypes: {
              ...
              states: {
                waiting: {
                  on: {
                    LOADED: {
                      actions: ['setCellTypes', 'setCells', 'setColorMap', 'updateColorMap'],
                      target: 'done',
                    },
                  },
                },
                      ...
                      states: {
                        editing: {
                          on: {
                            EDITED_CELLTYPES: {
                              target: 'done',
                              actions: ['setEditedCellTypes', 'setColorMap', 'updateColorMap'],
                            },
                          },
                        },
                        done: { type: 'final' },
    ...
    },
    {
      actions: {
        ...
        addCellType: send((ctx, evt) => {
          ...
          cellTypes = [
            ...ctx.cellTypes,
            { id: ctx.maxId + 1, name: `Untitled ${ctx.maxId + 1}`, color: evt.color, cells: [] },
          ];
          return { type: 'EDITED_CELLTYPES', cellTypes };
        }),
