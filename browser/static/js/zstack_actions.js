...
class ChangeChannel {
  ...
  do() {
    setView('channel', this.newValue);
    this.adjust(this.oldValue, this.newValue);
    // render_info_display();
  }

  undo() {
    setView('channel', this.oldValue);
